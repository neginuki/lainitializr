...
import world.sake.mylasta.direction.LainitializrFwAssistantDirector;
import world.sake.mylasta.direction.sponsor.LainitializrApiFailureHook;
import world.sake.mylasta.direction.sponsor.LainitializrListedClassificationProvider;
 ...
 * @author jflute
 */
public class MockLainitializrFwAssistantDirector extends LainitializrFwAssistantDirector {
    ...
    protected ListedClassificationProvider createListedClassificationProvider() {
        return new LainitializrListedClassificationProvider() {
    ...
    protected ApiFailureHook createApiFailureHook() {
        return new LainitializrApiFailureHook() {
