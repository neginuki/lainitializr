...
import world.sake.mylasta.action.LainitializrUserBean;
 ...
 * @author jflute
 */
public abstract class LainitializrBaseAction extends TypicalAction {
    ...
    //                                                                           =========
    @Override
    protected abstract OptionalThing<? extends LainitializrUserBean> getUserBean(); // to be more concrete
