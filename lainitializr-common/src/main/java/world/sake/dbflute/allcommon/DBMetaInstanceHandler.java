...
public class DBMetaInstanceHandler implements DBMetaProvider {
    ...
    static {
        ...
        tmpMap.put("member", "world.sake.dbflute.bsentity.dbmeta.MemberDbm");
        tmpMap.put("member_address", "world.sake.dbflute.bsentity.dbmeta.MemberAddressDbm");
        tmpMap.put("member_following", "world.sake.dbflute.bsentity.dbmeta.MemberFollowingDbm");
        tmpMap.put("member_login", "world.sake.dbflute.bsentity.dbmeta.MemberLoginDbm");
        tmpMap.put("member_security", "world.sake.dbflute.bsentity.dbmeta.MemberSecurityDbm");
        tmpMap.put("member_service", "world.sake.dbflute.bsentity.dbmeta.MemberServiceDbm");
        tmpMap.put("member_status", "world.sake.dbflute.bsentity.dbmeta.MemberStatusDbm");
        tmpMap.put("member_withdrawal", "world.sake.dbflute.bsentity.dbmeta.MemberWithdrawalDbm");
        tmpMap.put("product", "world.sake.dbflute.bsentity.dbmeta.ProductDbm");
        tmpMap.put("product_category", "world.sake.dbflute.bsentity.dbmeta.ProductCategoryDbm");
        tmpMap.put("product_status", "world.sake.dbflute.bsentity.dbmeta.ProductStatusDbm");
        tmpMap.put("purchase", "world.sake.dbflute.bsentity.dbmeta.PurchaseDbm");
        tmpMap.put("purchase_payment", "world.sake.dbflute.bsentity.dbmeta.PurchasePaymentDbm");
        tmpMap.put("region", "world.sake.dbflute.bsentity.dbmeta.RegionDbm");
        tmpMap.put("service_rank", "world.sake.dbflute.bsentity.dbmeta.ServiceRankDbm");
        tmpMap.put("withdrawal_reason", "world.sake.dbflute.bsentity.dbmeta.WithdrawalReasonDbm");
