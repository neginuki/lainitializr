...
public class ProductStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.ProductStatus"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.ProductStatusCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.ProductStatusBhv"; }
