...
public class MemberServiceDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberService"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberServiceCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberServiceBhv"; }
