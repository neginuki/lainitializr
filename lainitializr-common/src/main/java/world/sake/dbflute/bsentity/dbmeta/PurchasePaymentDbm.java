...
public class PurchasePaymentDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.PurchasePayment"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.PurchasePaymentCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.PurchasePaymentBhv"; }
