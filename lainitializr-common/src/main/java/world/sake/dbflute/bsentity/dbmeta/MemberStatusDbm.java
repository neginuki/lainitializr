...
public class MemberStatusDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberStatus"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberStatusCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberStatusBhv"; }
