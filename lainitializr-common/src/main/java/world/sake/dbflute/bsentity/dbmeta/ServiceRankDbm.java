...
public class ServiceRankDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.ServiceRank"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.ServiceRankCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.ServiceRankBhv"; }
