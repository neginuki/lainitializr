...
public class MemberLoginDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberLogin"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberLoginCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberLoginBhv"; }
