...
public class MemberFollowingDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberFollowing"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberFollowingCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberFollowingBhv"; }
