...
public class MemberAddressDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberAddress"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberAddressCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberAddressBhv"; }
