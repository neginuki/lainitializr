...
public class MemberWithdrawalDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.MemberWithdrawal"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberWithdrawalCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberWithdrawalBhv"; }
