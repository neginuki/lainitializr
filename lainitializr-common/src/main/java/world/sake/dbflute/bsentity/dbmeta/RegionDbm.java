...
public class RegionDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.Region"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.RegionCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.RegionBhv"; }
