...
public class PurchaseDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.Purchase"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.PurchaseCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.PurchaseBhv"; }
