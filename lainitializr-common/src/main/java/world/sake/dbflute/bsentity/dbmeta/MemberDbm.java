...
public class MemberDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.Member"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.MemberCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.MemberBhv"; }
