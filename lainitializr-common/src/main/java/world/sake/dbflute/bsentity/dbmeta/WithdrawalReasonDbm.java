...
public class WithdrawalReasonDbm extends AbstractDBMeta {
    ...
    //                                                                           Type Name
    //                                                                           =========
    public String getEntityTypeName() { return "world.sake.dbflute.exentity.WithdrawalReason"; }
    public String getConditionBeanTypeName() { return "world.sake.dbflute.cbean.WithdrawalReasonCB"; }
    public String getBehaviorTypeName() { return "world.sake.dbflute.exbhv.WithdrawalReasonBhv"; }
