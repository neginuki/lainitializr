 ...
 * @author FreeGen
 */
public interface LainitializrEnv {
    ...
    /** The key of the configuration. e.g. /tmp/lastaflute/lainitializr */
    ...
    /** The key of the configuration. e.g. jdbc:mysql://localhost:3306/lainitializrdb */
    String JDBC_URL = "jdbc.url";

    /** The key of the configuration. e.g. lainitializrdb */
     ...
     * The value is, e.g. /tmp/lastaflute/lainitializr <br>
     ...
     * The value is, e.g. jdbc:mysql://localhost:3306/lainitializrdb <br>
     ...
     * The value is, e.g. lainitializrdb <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends ObjectiveConfig implements LainitializrEnv {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getLastaDiSmartDeployMode() {
            return get(LainitializrEnv.lasta_di_SMART_DEPLOY_MODE);
        }

        public String getDevelopmentHere() {
            return get(LainitializrEnv.DEVELOPMENT_HERE);
        }

        public boolean isDevelopmentHere() {
            return is(LainitializrEnv.DEVELOPMENT_HERE);
        }

        public String getEnvironmentTitle() {
            return get(LainitializrEnv.ENVIRONMENT_TITLE);
        }

        public String getFrameworkDebug() {
            return get(LainitializrEnv.FRAMEWORK_DEBUG);
        }

        public boolean isFrameworkDebug() {
            return is(LainitializrEnv.FRAMEWORK_DEBUG);
        }

        public String getTimeAdjustTimeMillis() {
            return get(LainitializrEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public Long getTimeAdjustTimeMillisAsLong() {
            return getAsLong(LainitializrEnv.TIME_ADJUST_TIME_MILLIS);
        }

        public String getLogLevel() {
            return get(LainitializrEnv.LOG_LEVEL);
        }

        public String getLogConsoleLevel() {
            return get(LainitializrEnv.LOG_CONSOLE_LEVEL);
        }

        public String getLogFileBasedir() {
            return get(LainitializrEnv.LOG_FILE_BASEDIR);
        }

        public String getMailSendMock() {
            return get(LainitializrEnv.MAIL_SEND_MOCK);
        }

        public boolean isMailSendMock() {
            return is(LainitializrEnv.MAIL_SEND_MOCK);
        }

        public String getMailSmtpServerMainHostAndPort() {
            return get(LainitializrEnv.MAIL_SMTP_SERVER_MAIN_HOST_AND_PORT);
        }

        public String getMailSubjectTestPrefix() {
            return get(LainitializrEnv.MAIL_SUBJECT_TEST_PREFIX);
        }

        public String getMailReturnPath() {
            return get(LainitializrEnv.MAIL_RETURN_PATH);
        }

        public String getJdbcDriver() {
            return get(LainitializrEnv.JDBC_DRIVER);
        }

        public String getJdbcUrl() {
            return get(LainitializrEnv.JDBC_URL);
        }

        public String getJdbcUser() {
            return get(LainitializrEnv.JDBC_USER);
        }

        public String getJdbcPassword() {
            return get(LainitializrEnv.JDBC_PASSWORD);
        }

        public String getJdbcConnectionPoolingSize() {
            return get(LainitializrEnv.JDBC_CONNECTION_POOLING_SIZE);
        }

        public Integer getJdbcConnectionPoolingSizeAsInteger() {
            return getAsInteger(LainitializrEnv.JDBC_CONNECTION_POOLING_SIZE);
        }
    }
}
