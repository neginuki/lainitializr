 ...
 * @author jflute
 */
public class LainitializrCookieResourceProvider implements CookieResourceProvider {

    protected final LainitializrConfig config;
    protected final InvertibleCryptographer cookieCipher;

    public LainitializrCookieResourceProvider(LainitializrConfig config, InvertibleCryptographer cookieCipher) {
        this.config = config;
