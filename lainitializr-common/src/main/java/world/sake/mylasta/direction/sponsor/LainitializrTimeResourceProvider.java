 ...
 * @author jflute
 */
public class LainitializrTimeResourceProvider extends TypicalTimeResourceProvider {

    // ===================================================================================
    //                                                                           Attribute
    //                                                                           =========
    protected final LainitializrConfig config;

    // ===================================================================================
    //                                                                         Constructor
    //                                                                         ===========
    public LainitializrTimeResourceProvider(LainitializrConfig config) {
        this.config = config;
    }
    ...
    protected TimeZone getCentralTimeZone() {
        return LainitializrUserTimeZoneProcessProvider.centralTimeZone;
    }
