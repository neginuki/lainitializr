...
import world.sake.mylasta.direction.LainitializrEnv;
import org.lastaflute.core.direction.exception.ConfigPropertyNotFoundException;

/**
 * @author FreeGen
 */
public interface LainitializrConfig extends LainitializrEnv {

    /** The key of the configuration. e.g. lainitializr */
     ...
     * The value is, e.g. lainitializr <br>
     ...
     * @author FreeGen
     */
    public static class SimpleImpl extends LainitializrEnv.SimpleImpl implements LainitializrConfig {

        /** The serial version UID for object serialization. (Default) */
        private static final long serialVersionUID = 1L;

        public String getDomainName() {
            return get(LainitializrConfig.DOMAIN_NAME);
        }

        public String getDomainTitle() {
            return get(LainitializrConfig.DOMAIN_TITLE);
        }

        public String getAppStandardDatePattern() {
            return get(LainitializrConfig.APP_STANDARD_DATE_PATTERN);
        }

        public String getAppStandardDatetimePattern() {
            return get(LainitializrConfig.APP_STANDARD_DATETIME_PATTERN);
        }

        public String getAppStandardTimePattern() {
            return get(LainitializrConfig.APP_STANDARD_TIME_PATTERN);
        }

        public String getCookieDefaultPath() {
            return get(LainitializrConfig.COOKIE_DEFAULT_PATH);
        }

        public String getCookieDefaultExpire() {
            return get(LainitializrConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public Integer getCookieDefaultExpireAsInteger() {
            return getAsInteger(LainitializrConfig.COOKIE_DEFAULT_EXPIRE);
        }

        public String getCookieEternalExpire() {
            return get(LainitializrConfig.COOKIE_ETERNAL_EXPIRE);
        }

        public Integer getCookieEternalExpireAsInteger() {
            return getAsInteger(LainitializrConfig.COOKIE_ETERNAL_EXPIRE);
        }
    }
}
