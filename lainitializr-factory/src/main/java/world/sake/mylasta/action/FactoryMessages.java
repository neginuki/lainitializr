...
import world.sake.mylasta.action.FactoryLabels;
 ...
 * @author FreeGen
 */
public class FactoryMessages extends FactoryLabels {
     ...
     */
    @Override
    public FactoryMessages addConstraintsAssertFalseMessage(String property) {
     ...
     */
    @Override
    public FactoryMessages addConstraintsAssertTrueMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsDecimalMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsDecimalMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsDigitsMessage(String property, String fraction, String integer) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsEmailMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsFutureMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsMaxMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsMinMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsNotBlankMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsNotEmptyMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsNotNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsNullMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsPastMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsPatternMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsSizeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsCreditCardNumberMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsEanMessage(String property, String type) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsLengthMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsLuhnCheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsMod10CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsMod11CheckMessage(String property, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsModCheckMessage(String property, String modType, String value) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsParametersScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsRangeMessage(String property, String min, String max) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsSafeHtmlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsScriptAssertMessage(String property, String script) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsUrlMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsRequiredMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeAnyMessage(String property, String propertyType) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeIntegerMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeLongMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeLocalDateMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeLocalDateTimeMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addConstraintsTypeBooleanMessage(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsLoginFailure(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsAppIllegalTransition(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsAppDbAlreadyDeleted(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsAppDbAlreadyUpdated(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsAppDbAlreadyExists(String property) {
        assertPropertyNotNull(property);
     ...
     */
    @Override
    public FactoryMessages addErrorsAppDoubleSubmitRequest(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public FactoryMessages addErrorsLoginRequired(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public FactoryMessages addErrorsUnknownBusinessError(String property) {
        assertPropertyNotNull(property);
     ...
     * @return this. (NotNull)
     */
    public FactoryMessages addErrorsSignupAccountAlreadyExists(String property) {
        assertPropertyNotNull(property);
